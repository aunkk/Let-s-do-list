...
//    private String status;
    ...
    private void initComponents() {
        ...
        buttEditor.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                buttEditorMouseClicked(evt);
            }
        });
    ...
    private void buttEditorMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_buttEditorMouseClicked
        if (evt.getClickCount() == 2) {
            if (TaskPattern.getState() == 0) {
            openEDframe();
        }
    ...
    }//GEN-LAST:event_buttEditorMouseClicked
