...
public final class Dates extends javax.swing.JPanel implements MouseListener{
    static int state;
...
//        chooser.add(panelChooser);
//        t.taskinit.add(chooser);
//        t.taskinit.setVisible(true
        String scmd5 = cmd5.getText();
...
//        System.out.println(cmd1.getText());
    ...
    private void cmd10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmd10ActionPerformed
        ...
        String scmd10 = cmd10.getText()+ "-" + dateChooser.getCmdMonth();
    ...
    private void cmd32ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmd32ActionPerformed
        // TODO add your handling code here:
          DateChooser dateChooser = new DateChooser();
          String scmd32 = cmd32.getText() + "-" + dateChooser.getCmdMonth();
...
//        System.out.println(scmd33);
    ...
    public String cmdReturn(String str){
        return str;
    }              
