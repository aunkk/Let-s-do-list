...
public class NotepadGUI extends JInternalFrame implements ActionListener{
    ...
    private JScrollPane noteWithScrollPane;
    private JMenuBar menuBar;
    private JMenu menuDrawing, menuFile, menuFormat, menuEdit, menuAdd;
    private JMenuItem itemFree, itemErase, itemNew, itemOpen, itemSave,
            itemSaveAs, itemExit, itemDisplay, itemRedo, itemUndo, itemImages;
    private Functional_File file = new Functional_File(this);
    private Functional_Format format = new Functional_Format(this);
    private Functional_Edit edit = new Functional_Edit(this);
    private Functional_Add add = new Functional_Add(this);
    ...
    public void setNote(Notepad note) {
        this.note = note;
    }
    public JMenuItem getItemDisplay() {
        return itemDisplay;
    }

    public void setItemDisplay(JMenuItem itemDisplay) {
